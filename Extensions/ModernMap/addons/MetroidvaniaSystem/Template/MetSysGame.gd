...
## Like [method load_room], but also handles Fog Of Mystery transition. This should be the preferred method when using modern map.
func teleport_to_room(room: String):
	FogOfMystery.singleton.pre_new_room(room)
